...
alias claude-work="CLAUDE_CONFIG_DIR=~/.claude-account1 command claude --allow-dangerously-skip-permissions --chrome"
alias claude-personal="CLAUDE_CONFIG_DIR=~/.claude-account2 command claude --allow-dangerously-skip-permissions --chrome"
if [[ "$OSTYPE" == darwin* ]]; then
    alias claude="CLAUDE_CONFIG_DIR=~/.claude-account1 command claude --allow-dangerously-skip-permissions --chrome"
else
    # Linux box: Chrome runs on the VNC display :1, so point DISPLAY at it.
    alias claude="DISPLAY=\${DISPLAY:-:1} CLAUDE_CONFIG_DIR=~/.claude-account1 command claude --allow-dangerously-skip-permissions --chrome"
fi
